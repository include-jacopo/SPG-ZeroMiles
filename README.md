...
Web application for a solidarity purchasing group that connects farmers and customers. Created in a team of seven people with time management done on YouTrack, code quality handled with SonarCloud and distribuited via Docker. Developed with JS and the React-Bootstrap framework for the course of Software Engineering 2 at Politecnico di Torino.
